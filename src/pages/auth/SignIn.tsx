...
const AFUMAIL_AUTH_URL = 'https://vfcukxlzqfeehhkiogpf.supabase.co/functions/v1/afumail-api/oauth/authorize';
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3">
            ...
            <Button
              type="button"
              variant="outline"
              className="flex-1 h-14 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground"
