...
import { X } from 'lucide-react'; // Assuming lucide-react is available for icons; install if needed
...
const AuthSheet: React.FC<AuthSheetProps> = ({ isOpen, onOpenChange }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md p-0 overflow-hidden rounded-2xl shadow-2xl backdrop-blur-sm bg-card/95 border-border/20">
        {/* Smooth slide-in animation for professional feel */}
